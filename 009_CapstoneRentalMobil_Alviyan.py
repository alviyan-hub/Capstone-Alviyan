...
def perbarui_mobil():
    ...
    if 0 <= indeks < len(mobil_list):
        ...
        mobil_list[indeks]["warna_mobil"] = (input("Masukkan Warna Mobil Baru: "))
        mobil_list[indeks]["bensin"] = input("Masukkan Bensin Mobil: ")
        mobil_list[indeks]["KM"] = int(input("Masukkan KM Terbaru: "))
...
def menu():
    ...
    while True:
        print("\n=== ALVIYAN RENT ===")
        if user == "admin":
            print("1. Menambah Mobil Baru")
            print("2. Update Mobil")
            print("3. Delete List Mobil")
        ...
        if user == "admin":
            ...
            if pilihan == "1":
                ...
                print("Terima kasih! Telah Percaya dengan Alviyan Rent")
                break
menu()
